...
public class ClienteController extends HttpServlet {
	...
	public ClienteController() {
		...
		this.viewHorarios = "views/viewHorarios.jsp";
		this.formPage = "views/formCliente.jsp";
		this.notfoundPage = "views/notfound.jsp";
	}

	private void dispatchToPage(HttpServletRequest request, HttpServletResponse response, String page)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Listar Horarios
		if (app == null || app.equalsIgnoreCase("listarHorarios")) {
			request.setAttribute("clientes", dao.buscarHorario());
			dispatchToPage(request, response, viewHorarios);
			return;
		}
